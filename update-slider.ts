...
async function main() {
  ...
  // إضافة صور جديدة للملابس فقط مع التركيز على براند ستور
  await prisma.sliderImage.createMany({
    data: [
      {
        title: 'Brand Store Collection',
        titleAr: 'تشكيلة براند ستور الحصرية',
      ...
      {
        title: 'Men\'s Fashion',
        titleAr: 'أزياء رجالية من براند ستور',
      ...
      },
      {
        ...
        titleAr: 'تشكيلة السيدات من براند ستور',
      ...
      {
        title: 'Kids Fashion',
        titleAr: 'ملابس الأطفال - براند ستور',
      ...
      {
        title: 'Made in Egypt',
        titleAr: 'صُنع في مصر - براند ستور',
      ...
      {
        title: 'New Arrivals',
        titleAr: 'وصل حديثاً من مصنع براند ستور',
      ...
      },
      {
        ...
        titleAr: 'ضمان الجودة - براند ستور',
      ...
      },
      {
        ...
        titleAr: 'تشكيلة القمصان - براند ستور',
  ...
  console.log('🏭 جميع الصور تعكس منتجات براند ستور المصنعة محلياً');
}
