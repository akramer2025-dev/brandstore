      ...
      >
        {products.map((product, index) => {
          ...
          <div key={`${direction}-${product.id}-${index}`} className="flex-shrink-0 w-80">
            <Card className="border-0 shadow-xl hover:shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 overflow-hidden group hover:-translate-y-2 bg-white">
