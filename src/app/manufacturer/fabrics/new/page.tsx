  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push('/manufacturer/fabrics')
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-blue-400 mb-2">
          ...
          <Link href="/manufacturer/fabrics" className="hover:text-blue-300">الأقمشة</Link>
          <ArrowRight className="w-4 h-4" />
          <span className="text-white">إضافة قماش</span>
        </div>
      ...
      <Card className="bg-white/10 backdrop-blur-lg border-white/20 max-w-2xl">
        <CardHeader>
          <CardTitle className="text-white">بيانات القماش</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="text-white">اسم القماش (عربي)</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label className="text-white">اسم القماش (إنجليزي)</Label>
                <Input
                  value={formData.name}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <option value="ياردة" className="bg-gray-800">ياردة</option>
                  <option value="كيلو" className="bg-gray-800">كيلو</option>
                </select>
              </div>
              <div className="space-y-2">
                <Label className="text-white">السعر لكل وحدة</Label>
                <Input
                  type="number"
