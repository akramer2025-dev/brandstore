    ...
    >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3">
          ...
          <Link href="/developer/pricing">
            <Card className="backdrop-blur-sm bg-slate-950/90 border-purple-500/50 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-300 cursor-pointer h-full hover:-translate-y-2 hover:bg-slate-900/95 hover:border-green-500/60 group">
              <CardContent className="p-3 md:p-4 text-center">
                ...
                <p className="text-white font-black group-hover:text-green-300 transition-all text-sm md:text-base">حاسبة التسعير</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/vendor/store-address">
            <Card className="backdrop-blur-sm bg-slate-950/90 border-purple-500/50 hover:shadow-2xl hover:shadow-emerald-500/20 transition-all duration-300 cursor-pointer h-full hover:-translate-y-2 hover:bg-slate-900/95 hover:border-emerald-500/60 group">
              <CardContent className="p-3 md:p-4 text-center">
                <div className="text-emerald-400 mb-1 md:mb-2 transform group-hover:scale-110 transition-transform duration-300 w-10 h-10 md:w-12 md:h-12 mx-auto flex items-center justify-center">
                  <MapPin className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <p className="text-white font-black group-hover:text-emerald-300 transition-all text-sm md:text-base">عنوان المتجر</p>
                <p className="text-gray-300 text-[10px] md:text-xs mt-1 group-hover:text-gray-100 transition-colors font-medium hidden md:block">للشحن</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/vendor/offline-products">
            <Card className="backdrop-blur-sm bg-slate-950/90 border-purple-500/50 hover:shadow-2xl hover:shadow-violet-500/20 transition-all duration-300 cursor-pointer h-full hover:-translate-y-2 hover:bg-slate-900/95 hover:border-violet-500/60 group">
              <CardContent className="p-3 md:p-4 text-center">
                <div className="text-violet-400 mb-1 md:mb-2 transform group-hover:scale-110 transition-transform duration-300 w-10 h-10 md:w-12 md:h-12 mx-auto flex items-center justify-center">
                  <Package className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <p className="text-white font-black group-hover:text-violet-300 transition-all text-sm md:text-base">البضاعة الخارجية</p>
                <p className="text-gray-300 text-[10px] md:text-xs mt-1 group-hover:text-gray-100 transition-colors font-medium hidden md:block">تتبع المبيعات</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/vendor/offline-suppliers">
            <Card className="backdrop-blur-sm bg-slate-950/90 border-purple-500/50 hover:shadow-2xl hover:shadow-indigo-500/20 transition-all duration-300 cursor-pointer h-full hover:-translate-y-2 hover:bg-slate-900/95 hover:border-indigo-500/60 group">
              <CardContent className="p-3 md:p-4 text-center">
                <div className="text-indigo-400 mb-1 md:mb-2 transform group-hover:scale-110 transition-transform duration-300 w-10 h-10 md:w-12 md:h-12 mx-auto flex items-center justify-center">
                  <Users className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <p className="text-white font-black group-hover:text-indigo-300 transition-all text-sm md:text-base">موردين البضاعة</p>
                <p className="text-gray-300 text-[10px] md:text-xs mt-1 group-hover:text-gray-100 transition-colors font-medium hidden md:block">إدارة الموردين</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/vendor/expenses">
            <Card className="backdrop-blur-sm bg-slate-950/90 border-purple-500/50 hover:shadow-2xl hover:shadow-red-500/20 transition-all duration-300 cursor-pointer h-full hover:-translate-y-2 hover:bg-slate-900/95 hover:border-red-500/60 group">
              <CardContent className="p-3 md:p-4 text-center">
                <div className="text-red-400 mb-1 md:mb-2 transform group-hover:scale-110 transition-transform duration-300 w-10 h-10 md:w-12 md:h-12 mx-auto flex items-center justify-center">
                  <Receipt className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <p className="text-white font-black group-hover:text-red-300 transition-all text-sm md:text-base">المصروفات</p>
                <p className="text-gray-300 text-[10px] md:text-xs mt-1 group-hover:text-gray-100 transition-colors font-medium hidden md:block">تتبع المصروفات</p>
              </CardContent>
            </Card>
          </Link>
