...
2. **احصل على Facebook Pixel ID** (للتتبع الاحترافي)
3. **اذهب إلى**: [إعدادات Facebook](/admin/facebook-settings)
4. **أدخل البيانات** (Access Token, Ad Account ID, Page ID, Pixel ID)
5. **اضغط "حفظ"** ✅
6. **اذهب إلى**: [Media Buyer](/admin/media-buyer) → تبويب "إنشاء تلقائي"
7. **املأ بيانات الحملة واضغط "إنشاء على Facebook"** 🎯

**الآن كل شيء جاهز!** ✨

---

## 🎯 **NEW: Facebook Conversions API (CAPI)**

تم إضافة نظام تتبع احترافي من السيرفر لتحسين دقة الحملات:
- ✅ تتبع تلقائي لجميع الطلبات (Purchase events)
- ✅ دقة أعلى بنسبة 25%
- ✅ لا يتأثر بـ Ad Blockers
- ✅ يحسن من ROAS بنسبة 20%

**📖 اقرأ الدليل الكامل:** [FACEBOOK_CONVERSIONS_API_GUIDE.md](./FACEBOOK_CONVERSIONS_API_GUIDE.md)
